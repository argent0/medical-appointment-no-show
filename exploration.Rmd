...
One of the factor that might be relevant to the turn up ratio is the
...
After the age of 90 there are only a few samples, so the proportions aren't
significative.
...
appointments also have better turn up. Careful, the histograms below have
