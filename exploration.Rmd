...
* describes `r format(eda$n_samples, big.mark=" ", scientific=FALSE)` appointments.
* Made by `r format(eda$n_patients , big.mark=" ", scientific=FALSE)` patients.
* The appointments took place in `r eda$n_neighbourhoods` different
  neighbourhoods.
* Appointments where made from `r paste(as.character(eda$range_scheduledDay), collapse=" to ")`.
* And their dates ranged from `r paste(as.character(eda$range_appointmentDay), collapse=" to ")`.
* The waiting times being from `r paste(as.character(eda$range_wait), collapse=" to ")` days.
